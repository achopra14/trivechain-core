...
Only requiring some minor changes is trivechain.cpp.
...
Changes to trivechain.cpp
----------------------
trivechain.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
